...
export const Cards2 = ({ addByu, addtoVip }) => {

    const [cards, setCards] = useState([
        {
            id: 1, img: 'cardStocks/cards2/Kombain.png', heart: 'cardStocks/heart.png',
            discount: '-50%', priceForCard: '599,99 Р', itemName: 'Комбайн КЗС-1218 «ДЕСНА-ПОЛЕСЬЕ GS12»',
            starActive: 'cardStocks/StarActive.png', starFalse: 'cardStocks/starFalse.png'
        },
        {
            id: 2, img: 'cardStocks/cards2/kalbosa.png', heart: 'cardStocks/heart.png',
            discount: '-50%', priceForCard: '44,50 Р', itemName: 'Колбаса сырокопченая МЯСНАЯ ИСТОРИЯ Сальчичон и Тоскан...',
            starActive: 'cardStocks/StarActive.png', starFalse: 'cardStocks/starFalse.png'
        },
        {
            id: 3, img: 'cardStocks/cards2/sosiska.png', heart: 'cardStocks/heart.png',
            discount: '-50%', priceForCard: '159,99Р', itemName: 'Комбайн КЗС-1218 «ДЕСНА-ПОЛЕСЬЕ GS12»',
            starActive: 'cardStocks/StarActive.png', starFalse: 'cardStocks/starFalse.png'
        },
        {
            id: 4, img: 'cardStocks/cards2/moloko.png', heart: 'cardStocks/heart.png',
